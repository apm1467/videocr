...
def get_subtitles(
        ...
        conf_threshold=65, sim_threshold=90, tesseract_config='', roi=[[0, 1], [0, 1]], debug=False, num_jobs=None) -> str:
    ...
    v.run_ocr(
        ...
        roi=roi, debug=debug, num_jobs=num_jobs
    )
...
def save_subtitles_to_file(
        ...
        tesseract_config='', roi=[[0, 1], [0, 1]], debug=False, num_jobs=None) -> None:
